...
class UserTest < ActiveSupport::TestCase
  ...
  test 'correct get' do
    instance = User.new(username: 'TestUser', email: 'testmail@mail.com', password: 'testpass')
    assert_equal instance.username, 'TestUser'
  end
  ...
  test 'error short password' do
    ...
    instance.validate
    assert_equal(['is too short (minimum is 6 characters)'] || ["недостаточной длины (не может быть меньше 6 символов)"], instance.errors[:password])
  end
